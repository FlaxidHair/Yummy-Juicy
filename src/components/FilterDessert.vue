  ...
  <v-dialog max-width="800">
    <template v-slot:activator="{ props: activatorProps }">
      <div class="d-flex ga-5 flex-wrap justify-center">
        <div v-for="recipe in store.getterCategory.dessert" :key="recipe" class="d-flex w-25 ga-5 mb-7">
          <v-hover v-slot="{ isHovering, props }" open-delay="50">
            <div @click="() => {
              ...
              <v-card class="d-flex flex-column align-center" height="600" :class="(isHovering, props)" v-bind="props"
      ...
      <v-card class="d-flex flex-column">
        <div class="d-flex mt-1">
          <v-card-title class="d-flex">
            ...
            <v-btn width="150px" class="ml-5 mt-3 bg-red" text="Удалить" @click="store.dialog = true"></v-btn>
          </v-card-title>
