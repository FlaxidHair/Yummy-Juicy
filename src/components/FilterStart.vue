<template>
    <!-- <div class="d-flex justify-center ga-5 mb-7 flex-wrap">
                <v-hover v-for="recipe in store.getterRecipe.recipies" :key="item" v-slot="{ isHovering, props }" open-delay="50">
        ...
        <v-dialog max-width="800">
            <template v-slot:activator="{ props: activatorProps }">
                <div class="d-flex ga-5 flex-wrap justify-center">
                    <div v-for="recipe in store.getterRecipe.recipies" :key="recipe"
                        class="d-flex w-25 ga-5 mb-7">
          ...
          ></v-btn>
                    ...
                    <div class="d-flex ">
                        <div class="d-flex mt-5">
                            ...
                            <v-card-text class="border-thin py-2 px-1 ml-1"> {{ store.selectRecipe.Category
                                }}</v-card-text>
                        </div>
                        <div class="ml-auto d-flex border-thin py-1 px-1 mr-5">
                            ...
                            >
                            {{ store.getTime(store.selectRecipe.Time)
                            }}</v-card-subtitle>
                        </div>
