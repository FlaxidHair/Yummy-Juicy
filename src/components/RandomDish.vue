<template>
    <v-container class="d-flex w-75 bg-white mt-15 flex-column align-center elevation-3">
        <h2 class="align-self-center">Что поесть?</h2>
        <v-btn class="bg-red-accent-1  w-xl-33 w-lg-33 w-md-33 w-sm-50 w-100 mb-15 mt-10 text-white" @click="store.getRandom()">Выбрать что
            поесть!</v-btn>
        <div v-if="store.randomState == 1" class="d-flex flex-xl-row flex-lg-row flex-column flex-md-row flex-sm-column w-xl-75 w-lg-75 w-md-100 w-sm-100 w-100 mb-7 ga-10 justify-center">
            <v-card height="350" :elevation="4" class="w-xl-33 w-lg-33 w-md-25 w-sm-100 w-100 d-flex flex-column align-center">
